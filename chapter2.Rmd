...
To select the explanatory variables to the model I created a plot matrix.
...
The equation of the model is: y = 11.6 + 3.5 * attitude. The equation indicates that when a student's attitude increases with 1 in a scale from 1 to 5, his/her exam points increases with 3.5 points. For example, if the attitude is 1, the expected exam points are 15 and, correspondingly, when the attitude is 5, the expected exam points are 29.  Based on the model, attitude explains 19% of the variation in exam points (R2 = 0.19).
